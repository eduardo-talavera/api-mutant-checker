...
const Adns = require('../models/Adns');
...
exports.checkDna = async (req, res, next) => {
    ...
    let isInvalid = 0, stringNotComplete = 0;
    ...
    if(isInvalid > 0){
        ...
        if (stringNotComplete > 0) {
            res.json({mensaje: 'La secuencia genetica solo puede contener los valores: ATGC y la matriz esta incompleta'});
        } else {
